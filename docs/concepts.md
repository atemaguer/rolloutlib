...
`Dataset` and `RLDataset` describe pre-rollout task items and fresh environment
factories. Rubrics describe what should be evaluated; graders produce scalar or
structured `Score` values that environments can use as rewards.
